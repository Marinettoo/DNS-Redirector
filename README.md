...
![IONOS A config](IMAGES/A config.png)
![IONOS TXT config](IMAGES/TXT config.png)
...
![NOTION A CONFIG](IMAGES/Notion A config.png)
![NOTION TXT CONFIG](IMAGES/Notion TXT config.png)
